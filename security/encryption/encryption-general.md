...
- [Watch "Practical TLS - Free Lessons" on YouTube](https://youtube.com/playlist?list=PLIFyRwBY_4bTwRX__Zn4-letrtpSj1mzY)
...
- [Let's Encrypt Certificates in Azure with ACMEBot](https://samcogan.com/lets-encrypt-certificates-in-azure-with-acmebotot/)
...
- [Acme certs fail> "Not valid yet, let's wait 10 seconds and check next one."](https://forum.netgate.com/topic/188534/acme-certs-fail-not-valid-yet-let-s-wait-10-seconds-and-check-next-one)
- [PSA: GoDaddy has changed its API access. Affects ACME/LetsEncrypt](https://www.reddit.com/r/PFSENSE/comments/1cwuwdo/psa_godaddy_has_changed_its_api_access_affects/)
